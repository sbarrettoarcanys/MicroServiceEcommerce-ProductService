...
namespace ECommerce.ProductService.BusinessLogic.Managers
{
    public class HttpRequestManager : IHttpRequestManager
    {
        ...
        public HttpRequestManager(IHttpClientFactory httpClientFactory, ITokenProviderManager tokenProvider)
        {
            _httpClientFactory = httpClientFactory;
            _tokenProvider = tokenProvider;
        }

        public async Task<ResponseViewModel?> SendAsync(HttpRequestViewModel requestDto, bool withBearer = true)
        {
            try
            {
